...
Page.seed(:id) do |s|
  ...
  s.show_in_menu = true
  s.visible = true
  s.created_at = DateTime.parse('2012-11-18 06:38:34')
  s.updated_at = DateTime.parse('2018-08-14 11:26:48')
end
...
Page.seed(:id) do |s|
  ...
  s.show_in_menu = true
  s.visible = true
  s.created_at = DateTime.parse('2012-11-17 21:43:47')
  s.updated_at = DateTime.parse('2018-02-20 11:32:27')
end
...
Page.seed(:id) do |s|
  ...
  s.show_in_menu = true
  s.visible = true
  s.created_at = DateTime.parse('2012-11-17 21:46:26')
  s.updated_at = DateTime.parse('2014-07-04 18:42:46')
end
...
Page.seed(:id) do |s|
  ...
  s.show_in_menu = true
  s.visible = true
  s.created_at = DateTime.parse('2014-07-18 00:19:49')
  s.updated_at = DateTime.parse('2017-03-04 01:41:13')
end
...
Page.seed(:id) do |s|
  ...
  s.visible = true
  s.created_at = DateTime.parse('2015-01-29 00:05:50')
  s.updated_at = DateTime.parse('2015-05-19 23:54:05')
end
